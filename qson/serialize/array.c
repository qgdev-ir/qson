...
qson_result_t qson_serialize_array(qson_serialize_ctx_t ctx) {
...
qson_result_t qson_serialize_array_entry_string(qson_serialize_ctx_t ctx, char *value, bool has_next) {
	struct qson_serialize_ctx *c = ctx;
...
qson_result_t qson_serialize_array_entry_null(qson_serialize_ctx_t ctx, bool has_next) {
	struct qson_serialize_ctx *c = ctx;
	if (c->state != QSON_SERIALIZE_STATE_ARRAY) return QSON_RESULT_INVALID_STATE;
...
qson_result_t qson_serialize_array_entry_bool(qson_serialize_ctx_t ctx, bool value, bool has_next) {
	struct qson_serialize_ctx *c = ctx;
	if (c->state != QSON_SERIALIZE_STATE_ARRAY) return QSON_RESULT_INVALID_STATE;
...
qson_result_t qson_serialize_array_entry_number(qson_serialize_ctx_t ctx, double value, bool has_next) {
	struct qson_serialize_ctx *c = ctx;
	if (c->state != QSON_SERIALIZE_STATE_ARRAY) return QSON_RESULT_INVALID_STATE;
...
qson_result_t qson_serialize_array_entry_subctx(qson_serialize_ctx_t ctx, qson_serialize_ctx_t *sub_ctx) {
	struct qson_serialize_ctx *c = ctx;
	if (c->state != QSON_SERIALIZE_STATE_ARRAY) return QSON_RESULT_INVALID_STATE;
...
qson_result_t qson_serialize_array_entry_subctx_end(qson_serialize_ctx_t ctx, qson_serialize_ctx_t sub_ctx, bool has_next) {
	struct qson_serialize_ctx *c = ctx;
